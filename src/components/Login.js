...
import { Typography, Container, makeStyles, Backdrop, CircularProgress } from '@material-ui/core'
    ...
    const responseGoogle = (res) => {
        ...
        try {
            ...
            const login = async () => {
                ...
                const userExists = users.filter(u => u.googleId === res.profileObj.googleId)
